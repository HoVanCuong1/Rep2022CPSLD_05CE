...
struct Zodiac createZodiac(int startMonth, int startDay, int endMonth, int endDay, string name) {
...
void init(struct Zodiac* zodiacs) {
...
string findZodiac(struct Zodiac* zodiacs, int month, int day) {
...
int main() {
    struct Zodiac* zodiacs = new Zodiac[NUMBER_OF_ZODIAC];
    init(zodiacs);
    int day, month;
